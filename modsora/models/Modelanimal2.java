...
public static class Modelanimal2 extends ModelBase {
	...
	public Modelanimal2() {
		...
		unknown_bone_r1.cubeList
				.add(new ModelBox(unknown_bone_r1, 27, 22, -1.0F, -16.5622F, 3.1699F, 2, 3, 4, 0.0F, false));
		...
		unknown_bone_r2.cubeList
				.add(new ModelBox(unknown_bone_r2, 30, 41, 8.0F, -22.0841F, -15.8796F, 4, 4, 9, 0.0F, false));
		unknown_bone_r2.cubeList
				.add(new ModelBox(unknown_bone_r2, 46, 0, -12.0F, -22.0841F, -15.8796F, 4, 4, 9, 0.0F, false));
		...
		unknown_bone_r3.cubeList
				.add(new ModelBox(unknown_bone_r3, 23, 41, -4.4628F, -9.981F, -8.0F, 5, 2, 2, 0.0F, false));
		...
		unknown_bone_r4.cubeList
				.add(new ModelBox(unknown_bone_r4, 0, 40, -4.0F, -15.732F, -5.3398F, 8, 6, 7, 0.0F, false));
		...
		unknown_bone_r5.cubeList
				.add(new ModelBox(unknown_bone_r5, 20, 61, -8.7707F, -18.0935F, -23.7106F, 7, 4, 4, 0.0F, false));
		...
		unknown_bone_r6.cubeList
				.add(new ModelBox(unknown_bone_r6, 63, 63, 0.8871F, -20.2902F, -17.0F, 7, 4, 4, 0.0F, false));
		...
		unknown_bone_r7.cubeList
				.add(new ModelBox(unknown_bone_r7, 58, 41, -1.2045F, -17.4801F, -24.4549F, 7, 4, 4, 0.0F, false));
		...
		unknown_bone_r8.cubeList
				.add(new ModelBox(unknown_bone_r8, 62, 13, -7.8643F, -20.4632F, -17.0F, 7, 4, 4, 0.0F, false));
		...
		unknown_bone_r9.cubeList
				.add(new ModelBox(unknown_bone_r9, 0, 22, 1.0F, -27.725F, -0.2697F, 2, 4, 2, 0.0F, false));
		unknown_bone_r9.cubeList
				.add(new ModelBox(unknown_bone_r9, 0, 22, 1.0F, -27.725F, -0.2697F, 2, 4, 2, 0.0F, false));
		...
		unknown_bone_r10.cubeList
				.add(new ModelBox(unknown_bone_r10, 47, 41, -4.0F, -26.3108F, -10.1692F, 2, 4, 2, 0.0F, false));
		unknown_bone_r10.cubeList
				.add(new ModelBox(unknown_bone_r10, 29, 75, -1.0F, -7.38F, 14.3194F, 2, 8, 2, 0.0F, false));
		...
		unknown_bone_r11.cubeList
				.add(new ModelBox(unknown_bone_r11, 0, 0, 9.9215F, -15.1354F, -13.0F, 1, 8, 3, 0.0F, false));
		...
		unknown_bone_r12.cubeList
				.add(new ModelBox(unknown_bone_r12, 72, 0, -10.4989F, -14.2291F, -13.0F, 1, 7, 3, 0.0F, false));
		...
		unknown_bone_r13.cubeList
				.add(new ModelBox(unknown_bone_r13, 35, 54, 4.0F, -6.6816F, 5.37F, 3, 3, 3, 0.0F, false));
		unknown_bone_r13.cubeList
				.add(new ModelBox(unknown_bone_r13, 69, 21, -6.0F, -6.6816F, 5.37F, 3, 3, 3, 0.0F, false));
		unknown_bone_r13.cubeList
				.add(new ModelBox(unknown_bone_r13, 76, 76, -8.0F, -2.5774F, -5.9063F, 3, 3, 3, 0.0F, false));
		unknown_bone_r13.cubeList
				.add(new ModelBox(unknown_bone_r13, 76, 38, 5.0F, -2.5774F, -5.9063F, 3, 3, 3, 0.0F, false));
	}
