...
public class ProcedureXPRightClickedInAir extends ElementsModsoraMod.ModElement {
	public ProcedureXPRightClickedInAir(ElementsModsoraMod instance) {
		super(instance, 112);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure XPRightClickedInAir!");
			return;
		}
