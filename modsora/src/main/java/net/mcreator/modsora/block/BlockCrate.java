...
public class BlockCrate extends ElementsModsoraMod.ModElement {
	@GameRegistry.ObjectHolder("modsora:crate")
	public static final Block block = null;
	public BlockCrate(ElementsModsoraMod instance) {
		super(instance, 54);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("modsora:crate", "inventory"));
	}
