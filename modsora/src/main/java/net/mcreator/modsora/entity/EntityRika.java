...
public class EntityRika extends ElementsModsoraMod.ModElement {
	public static final int ENTITYID = 12;
	public static final int ENTITYID_RANGED = 13;
	public EntityRika(ElementsModsoraMod instance) {
		super(instance, 113);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("modsora", "rika"), ENTITYID)
				.name("rika").tracker(64, 3, true).egg(-10027162, -1).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelRika(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("modsora:textures/rika.png");
				}
			};
		});
	}
